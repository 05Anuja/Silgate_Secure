...
export function AIDrivenSolutions() {
  const data = whatWeDoData.aiDrivenSolutions;

  const getPillarIcon = (idx) => {
    switch (idx) {
      case 0: return <Handshake size={28} className="text-[#00cfff]" />;
      case 1: return <Bot size={28} className="text-[#00cfff]" />;
      case 2: return <Radio size={28} className="text-[#00cfff]" />;
      case 3: return <Users size={28} className="text-[#00cfff]" />;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        {/* Hero Section */}
        <section className="py-20 lg:py-28 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0A1628] via-[#0d223d] to-[#0A1628] text-white text-center relative overflow-hidden">
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-8 max-w-2xl mx-auto">
              Harnessing indigenous Make-in-India drone defense, automated airspace surveillance, and AI crowd analytics for public safety and enterprise perimeters.
            </p>
            <a 
            ...
            >
              Consult AI Solution Architect <ArrowRight size={16} />
            </a>
          </div>
        </section>

        {/* Why Choose Signellent AI-Driven Solutions */}
          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-gray-600 text-base">
                Intelligent aerial defense and machine-learning intelligence tailored for mission-critical security.
              </p>
            </div>
