...
export function AIDrivenSolutions() {
  ...
  const getPillarIcon = (idx) => {
    switch (idx) {
      case 0: return <Handshake size={28} className="text-[#F8B83A]" />;
      case 1: return <Bot size={28} className="text-[#F8B83A]" />;
      case 2: return <Radio size={28} className="text-[#F8B83A]" />;
      case 3: return <Users size={28} className="text-[#F8B83A]" />;
