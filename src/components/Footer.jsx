  ...
  return (
    <footer className="site-footer">
      <div className="container">
        ...
        <div className="footer-top-grid">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Signellent Technologies Limited is a leading provider of enterprise networking, cybersecurity, unified collaboration, and sovereign digital defense platforms.
            </p>
        ...
        <div className="footer-bottom-offices">
          ...
          <div className="offices-grid">
            {footerData.regionalOffices.map((office, idx) => (
              <div key={idx} className="office-tag">
                <img src={office.icon} alt="" className="w-4 h-4 object-contain opacity-70" />
        ...
        <div className="footer-copyright">
          ...
          <div className="flex items-center gap-6 text-xs text-gray-500">
            <a href="https://signellent.com/privacy-policy/" className="hover:text-primary-blue transition-colors">Privacy Policy</a>
            <span>•</span>
            <a href="https://signellent.com/terms/" className="hover:text-primary-blue transition-colors">Terms of Use</a>
          </div>
        </div>
      </div>
    </footer>
